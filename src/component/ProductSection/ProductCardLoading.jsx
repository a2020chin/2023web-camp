const ProductCardLoading = () => {
  return (
    <li className="flex flex-col rounded-2xl border-[1px] border-solid border-black-200 overflow-hidden cursor-pointer text-black-1000 animate-pulse">
      <div className="flex items-center justify-center w-full mb-4 bg-gray-300">
        <svg
      ...
      <div className="flex-1 px-8 py-5 border-b-[1px] border-solid border-black-200">
        <div className="h-2.5 bg-gray-200 rounded-full w-1/2 mb-3"></div>
